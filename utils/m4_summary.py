...
class M4Summary:
    ...
    def evaluate(self):
        ...
        for group_name in M4Meta.seasonal_patterns:
            ...
            naive2_forecast = np.array(group_values(naive2_forecasts, self.test_set.groups, group_name))
            target = np.array(group_values(self.test_set.values, self.test_set.groups, group_name))
